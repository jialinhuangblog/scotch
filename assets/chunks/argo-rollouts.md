...
靠人看 dashboard 反應太慢，AnalysisRun 會自動查詢 Prometheus metrics：
...
ArgoCD 把 Rollout CRD 從 Git sync 到 cluster 之後，由 Rollouts controller 接手執行 canary 或 blue-green 策略，控制流量。
