...
title: "VPC"
slug: vpc
brief: "雲端上的私有網路。VPC 有自己的私有 IP 範圍，外部無法直接存取裡面的資源。"
date: 2026-03-14
---

# VPC

VPC（Virtual Private Cloud）是在公有雲上劃出的一塊隔離的私有網路。
...
VPC 定義 CIDR 範圍，Subnet 再從中切出更小的區段。AWS 的 subnet 各自綁一個 Availability Zone，GCP 的 subnet 則涵蓋整個 region。
